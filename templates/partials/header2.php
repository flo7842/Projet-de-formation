        ...
        <ul>
            ...
            <?php if(isset($_SESSION['user'])){ ?>
                <?php if($_SESSION['user']['role'] === 'ROLE_USER'){ ?>
                    ...
                    <li>
                        <a href="#" class="list-deroulante">Association</a>
                        <ul class="sous-menu sous-menu-bis">
                ...
                <?php if($_SESSION['user']['role'] === 'ROLE_ADMIN'){ ?>
                    ...
                    <li>
                        <a href="#" class="list-deroulante">Articles</a>
                        <ul class="sous-menu-sc sous-menu-sc-bis">
